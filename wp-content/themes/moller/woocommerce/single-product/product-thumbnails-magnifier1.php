...
if ($attachment_ids) {
    ...
    <div class="thumbnails-container">
        <div class="thumbnails <?php if($enable_slider){ echo 'slider';} else { echo 'noslider';} ?>">
            <ul class="yith_magnifier_gallery" data-columns="<?php echo esc_attr($columns); ?>" data-circular="<?php echo get_option ( 'yith_wcmg_slider_circular' ); ?>" data-slider_infinite="<?php echo get_option ( 'yith_wcmg_slider_infinite' ); ?>" data-auto_carousel="<?php echo get_option ( 'ywzm_auto_carousel' ); ?>">
                <?php
                $loop = 1;
