...
$moller_mainextraclass = NULl;
if($moller_blogsidebar=='left') {
	$moller_mainextraclass = 'order-lg-last';
}
switch($moller_bloglayout) {
	case 'sidebar':
		$moller_blogclass = 'blog-sidebar';
		$moller_blogcolclass = 9;
		Moller_Features::moller_post_thumbnail_size('moller-category-thumb');
		break;
	default:
...
<div class="main-container page-wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-12 <?php echo 'col-lg-'.$moller_blogcolclass; ?> <?php echo esc_attr($moller_mainextraclass);?>">
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class( 'image-attachment' ); ?>>
							<div class="entry-content">
								<div class="post-thumbnail">
									<div class="entry-attachment">
										<div class="attachment">
											 ...
											 * }
											 */
											$attachment_size = apply_filters( 'moller_attachment_size', array( 960, 960 ) );
								...
								<div class="entry-description">
									<?php the_content(); ?>
									<?php wp_link_pages( array( 'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'moller' ), 'after' => '</div>' ) ); ?>
								...
								<div class="post-info">
									...
									<footer class="entry-meta">
										<?php
											...
											printf( wp_kses(__( '<span class="meta-prep meta-prep-entry-date">Published </span> <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s">%4$s &times; %5$s</a> in <a href="%6$s" rel="gallery">%8$s</a>.', 'moller' ), array('span'=>array('class'=>array()), 'a'=>array('href'=>array(), 'title'=>array(), 'rel'=>array()), 'time'=>array('class'=>array(), 'datetime'=>array()))),
										...
										?>
										<?php edit_post_link( esc_html__( 'Edit', 'moller' ), '<span class="edit-link">', '</span>' ); ?>
									</footer><!-- .entry-meta -->
								</div>
							</div>
						</article><!-- #post -->
